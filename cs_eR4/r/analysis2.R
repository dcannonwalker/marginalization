...
eR_fit <- readRDS("cs_eR4/data/eR_fit.rds")
...
saveRDS(b1_plot, file = "cs_eR4/data/b1_plot.rds")
saveRDS(roc_plot, file = "cs_eR4/data/roc_plot.rds")
saveRDS(fdr_plot, file = "cs_eR4/data/fdr_plot.rds")