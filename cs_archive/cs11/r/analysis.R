...
sim_list <- readRDS("cs11/data/sim_list.rds")
G <- sim_list$G
stan_post <- readRDS("cs11/data/stan_fit.rds")
jags_post <- readRDS("cs11/data/jags_fit.rds")
...
gg2
saveRDS(gg1, "cs11/data/gg1.rds")
saveRDS(gg2, "cs11/data/gg2.rds")
