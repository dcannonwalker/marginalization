...
G <- sim_list$G
stan_post <- readRDS("cs7/data/stan_fit.rds")
jags_post <- readRDS("cs7/data/jags_fit.rds")
...
gg2
saveRDS(gg1, "cs7/data/gg1.rds")
saveRDS(gg2, "cs7/data/gg2.rds")
