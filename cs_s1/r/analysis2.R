...
G <- sim_list$G
stan_post <- readRDS("cs_s1/data/stan_fit.rds")
eR_fit <- readRDS("cs_s1/data/eR_fit.rds")
# stan_smry <- stan_post$summary()
stan_smry <- readRDS("cs_s1/data/stan_smry.rds")
...
saveRDS(b1_plot, file = "cs_s1/data/b1_plot.rds")
saveRDS(roc_plot, file = "cs_s1/data/roc_plot.rds")
saveRDS(fdr_plot, file = "cs_s1/data/fdr_plot.rds")
