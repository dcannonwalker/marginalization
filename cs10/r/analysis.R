...
sim_list <- readRDS("cs10/data/sim_list.rds")
G <- sim_list$G
stan_post <- readRDS("cs10/data/stan_fit.rds")
jags_post <- readRDS("cs10/data/jags_fit.rds")
...
gg2
saveRDS(gg1, "cs10/data/gg1.rds")
saveRDS(gg2, "cs10/data/gg2.rds")
